...
public final class MockHorizontalScroll extends MockContainer {
  ...
  public MockHorizontalScroll(SimpleEditor editor) {
    ...
    super(editor, TYPE, images.scrollh(), MockHVArrangementHelper.makeLayout(0));
...
*/
    ...
    try {
      setMyHAlignmentPropertyEditor(PropertiesUtil.getHAlignmentEditor(properties));
      setMyVAlignmentPropertyEditor(PropertiesUtil.getVAlignmentEditor(properties));
...
public YoungAndroidHorizontalAlignmentChoicePropertyEditor getMyHAlignmentPropertyEditor() {
	return myHAlignmentPropertyEditor;
}

public void setMyHAlignmentPropertyEditor(YoungAndroidHorizontalAlignmentChoicePropertyEditor myHAlignmentPropertyEditor) {
	this.myHAlignmentPropertyEditor = myHAlignmentPropertyEditor;
}

public YoungAndroidVerticalAlignmentChoicePropertyEditor getMyVAlignmentPropertyEditor() {
	return myVAlignmentPropertyEditor;
}

public void setMyVAlignmentPropertyEditor(YoungAndroidVerticalAlignmentChoicePropertyEditor myVAlignmentPropertyEditor) {
	this.myVAlignmentPropertyEditor = myVAlignmentPropertyEditor;
}
