...
public final class YoungAndroidColorChoicePropertyEditor extends ColorChoicePropertyEditor {
  ...
  private static final Color[] YA_COLORS = {
    ...
    new Color(MESSAGES.blackColor(), Color.ALPHA_OPAQUE, "000000"),
     new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "1ABC9C"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "2ECC71"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "3498DB"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "9B59B6"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "34495E"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "F39C12"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "D35400"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "C0392B"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "BDC3C7"),
    new Color(MESSAGES.coloresUi(), Color.ALPHA_OPAQUE, "7F8C8D"),
