...
@SimpleObject
public class VerticalScroll extends AndroidViewComponent implements Component, ComponentContainer {
  private final Activity context;

  // Layout
  //private final int orientation;
  private final VerticalScrollView viewLayout;
  ...
  */
  public VerticalScroll(ComponentContainer container) {
    super(container);
    ...
    viewLayout = new VerticalScrollView(context,
